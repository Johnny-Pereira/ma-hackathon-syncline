...
function Index() {
  return (
    <div className="p-2">
      ...
      <p>
        By embracing anonymity, administration can create active change based on
        feedback and recommendations from their teammates, leading to a more
        dynamic and effective organization.
      </p>
